        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-white">
            ...
            <div className="w-full max-w-md p-8 space-y-4 bg-white rounded-lg border border-gray-300">
                ...
                <div className="text-center">
                    <h2 className="text-2xl font-bold text-red-500 mb-5">Verif email address</h2>
                    <p className="text-gray-600 mb-3 text-sm">
                        A text with a One Time Password (OTP) has been sent to your email address : Jhonehgm32@gmail.com <span className="text-red-500 cursor-pointer font-medium text-md">Change</span>
                    </p>
                </div>
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 mt-1 border border-gray-300 rounded-lg focus:ring-red-500 focus:border-red-500"
                    />
